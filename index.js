...
const EXCHANGE_ADDRESS = '0x02f055b6719919d69af7c63c8ab4abb380383925'
const exchangeContract = new web3.get.Contract(EXCHANGE_ABI,EXCHANGE_ADDRESS)

const ETH_AMOUNT = web3.utils.toWei('1', 'Ether')
console.log("Eth Amount", ETH_AMOUNT)

const ETH_SELL_PRICE = web3.utils.toWei('200', 'Ether')
